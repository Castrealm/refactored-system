...
$query = "SELECT count(*) AS total FROM tbl_inbox where inbox_to='$username' and notification = 'unread'"; 
...
$id = $_GET['id'];
	...
	$sql= "Select * from tbl_inbox where inbox_id = '$id'";
...
<?php
 	$con=mysqli_connect ("localhost", "root", "", "mysqli_prm"); 
	$sql= "UPDATE `tbl_inbox` SET `notification`='read' WHERE inbox_id = '$id'";
                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                                    <div> <a href="inbox2.php" class="btn btn-custom btn-block waves-effect waves-light">Compose</a>
                                        <div class="list-group mail-list m-t-20"> <a href="#" class="list-group-item active">Inbox <span class="label label-rouded label-success pull-right"><?php echo $num_rows; ?></span></a> <a href="#" class="list-group-item">Sent Mail</a> </div>
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 mail_listing">
                                    ...
                                    <div class="media m-b-30 p-t-20">
                                        <h4 class="font-bold m-t-0"><?php echo $subject; ?></h4>
                                        <hr>
                                        
                                        <div class="media-body"> <span class="media-meta pull-right"><?php echo $date_sent; ?></span>
                                             <small class="text-muted">From: <?php echo $inbox_from; ?></small> </div>
                                    </div>
