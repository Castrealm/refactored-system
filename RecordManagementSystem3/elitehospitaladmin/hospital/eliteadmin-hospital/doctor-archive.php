            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Archive Records</h4>
                    </div>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
...
<?php
		...
		$query = "select * from tbl_appointment where doctor= '$first_name' and status= 'closed' or status= 'Canceled(Admin)' or status='Canceled(User)'";
