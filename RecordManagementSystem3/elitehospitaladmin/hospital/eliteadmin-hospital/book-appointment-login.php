...
<?php if(isset($_POST['btn-appoint'])) {
 ...
 $user_appointed = $userRow['first_name'];
 $address = strip_tags($_POST['address']);
 $date_birth = strip_tags($_POST['date_birth']);
 $gender = strip_tags($_POST['gender']);
 if (mysql_real_escape_string($_POST['specialization']) == 1) {
	 
	 $specialization = "Allergist";
	 
 }
  else if (mysql_real_escape_string($_POST['specialization']) == 2) {
	 
	 $specialization = "Anesthesiologist ";
	 
 }
 
 else if (mysql_real_escape_string($_POST['specialization']) == 3) {
	 
	 $specialization = "Cardiologist ";
	 
 }
 else if (mysql_real_escape_string($_POST['specialization']) == 4) {
	 
	 $specialization = "Dermatologist ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 5) {
	 
	 $specialization = "Gastroenterologist ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 6) {
	 
	 $specialization = "Hematologist";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 7) {
	 
	 $specialization = "Internal Medicine Physician";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 8) {
	 
	 $specialization = "Nephrologist ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 9) {
	 
	 $specialization = "Obstetrician  ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 10) {
	 
	 $specialization = "Gynecologist   ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 11) {
	 
	 $specialization = "Ophthalmologist    ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 12) {
	 
	 $specialization = "Pediatrician    ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 13) {
	 
	 $specialization = "Psychiatrist    ";
	 
 }else if (mysql_real_escape_string($_POST['specialization']) == 14) {
	 
	 $specialization = "Rheumatologist     ";
	 
 }
 else if (mysql_real_escape_string($_POST['specialization']) == 15) {
 ...
 $str = $userRow['username'];
  ...
  $query = "INSERT INTO tbl_appointment(patient_name, user_appointed ,address,date_birth,gender,specialization,doctor,pref_date,pref_time,email,phone, Status) VALUES('$patient_name', '$str' ,'$address','$date_birth','$gender','$specialization','$doctor','$pref_date','$pref_time','$email','$phone', 'Confirmation' )";
