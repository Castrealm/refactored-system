...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Pending Leave Records</h4>
                    </div>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
 ...
 <table id="myTable">
  ...
  <th align="center">Leave Reason</th>
...
<?php
		...
		<?php echo "<td><a href =approve-leave.php?id=".$row['leave_id']."><button>Approve</button>";?><br>
		<?php echo "<td><a href =reject-leave.php?id=".$row['leave_id']."><button>Reject</button>";?><br>
