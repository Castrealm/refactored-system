            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Accepted Records</h4>
                    </div>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
...
<?php
		...
		$query = "select * from tbl_appointment where hr_name='$str' and status != 'closed' and status != 'Canceled(Admin)' and status != 'Canceled(User)'";
		...
		echo "<td> <a href =edit-appoint.php?id=".$row['appoint_id']."><button>Edit</button>";?>
		<td>
		 <?php
		  if( $status != "Open") {
		 echo "<a href =confirm-appoint.php?id=".$row['appoint_id']."><button>Confirm</button>";?><br></div>
			</td>
			
		  <?php } echo "<td><a href =close-appoint.php?id=".$row['appoint_id']."><button>Close</button>";?><br>
		</tr>
