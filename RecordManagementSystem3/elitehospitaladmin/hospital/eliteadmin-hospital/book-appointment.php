...
<?php
		...
		$query = "select * from tbl_appointment where hr_name= '' and status != 'closed' and status != 'Canceled(Admin)' and status != 'Canceled(User)'";
        ...
        <?php echo "<td><a href =accept-appoint.php?id=".$row['appoint_id']."><button>Accept</button>";?><br>
		<?php echo "<td><a href =cancel-appoint.php?id=".$row['appoint_id']."><button>Cancel</button>";?><br></div>
		</tr>
		<?php } ?>
		 </table>
