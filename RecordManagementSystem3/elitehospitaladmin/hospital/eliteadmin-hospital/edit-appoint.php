        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <!-- /.col-lg-12 -->
			<form action = "edit-appoint2.php" method= "post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
            <input type="date" value="<?php echo $pref_date; ?>" name="pref_date" required />
            </div>
            </div>
			<div class="form-group">
            ...
            <div class="col-md-12">
            <input type="text" value="<?php echo $pref_time; ?>" id="date-time" name="pref_time" class="form-control" placeholder="Enter Preffered Time" data-mask=" 99:99 am" required />
            </div>
            </div>
            <div class="form-group">
