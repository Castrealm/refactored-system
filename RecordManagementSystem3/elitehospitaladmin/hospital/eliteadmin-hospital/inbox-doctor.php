                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                                    <div> <a href="inbox2-doctor.php" class="btn btn-custom btn-block waves-effect waves-light">Compose</a>
                                        <div class="list-group mail-list m-t-20"> <a href="inbox-doctor.php" class="list-group-item active">Inbox <span class="label label-rouded label-success pull-right"><?php echo $num_rows; ?></span></a> </div>
                                    ...
                                    <div class="inbox-center">
                                        <table class="table table-hover">
											...
											?>
                                                ...
                                                <?php echo "<td class=max-texts>  <a href =inbox-detail-doctor.php?id=".$row['inbox_id'].">  $subject</td>"; ?>
                                                    </td>
