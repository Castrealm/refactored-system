...
<?php if(isset($_POST['btn-appoint'])) {
 ...
 $disease = strip_tags($_POST['disease']);
 $date_admit = strip_tags($_POST['date_admit']);
 $email = strip_tags($_POST['email']);
 $phone = strip_tags($_POST['phone']);



  $query = "INSERT INTO tbl_admission(patient_name,date_birth,gender,disease,date_admit,email,phone) VALUES('$patient_name','$date_birth','$gender','$disease','$date_admit','$email','$phone')";
  if ($DBcon->query($query)) {
echo '<script type = "text/javascript">
	alert("Admission form sent successfully!");
</script>';
  }else {
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12"><br><b>Health Condition</b></label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="date-time"><br><b>Date and Time of Admission</b></span><span class="text-muted font-12 p-l-20">(e.g. "12/10/2017 05:15 pm")</span></label>
                                    <div class="col-md-12">
                                        <input type="text" id="date-time" name="date_admit" class="form-control" placeholder="enter date and time of appointment" data-mask="99/99/9999 99:99 am">
                                    </div>
                                </div>
                                <div class="form-group">
