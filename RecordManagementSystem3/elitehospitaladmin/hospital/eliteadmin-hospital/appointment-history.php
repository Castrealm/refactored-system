...
<?php
		...
		$query = "select * from tbl_appointment where user_appointed = '$str' and status = 'closed' or status='Canceled(Admin)' or status='Canceled(User)'";
		...
		echo "<td> <a href =accept-appoint.php?id=".$row['appoint_id']."><button>Accept</button>";?><br></div>
		</tr>
